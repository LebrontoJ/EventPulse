...
| `src/test/java/com/eventpulse/` | Unit tests for parsing, generation, processing, and validation and application configuration. |
...
- Unit tests for parser, validation, configuration loading, application configuration, and processing error classification.
